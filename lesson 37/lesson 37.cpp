...
public:
    ...
    bool Init()
    {
        ...
        if (!m_quad.LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 33/Content/quad.obj")) {
            return false;
        }

        if (!m_box.LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 33/Content/box.obj")) {
            return false;
        }

        if (!m_bsphere.LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 33/Content/sphere.obj")) {
            return false;
        }
